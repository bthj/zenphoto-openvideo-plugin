...
<div id="main">
	...
	<div id="gallerytitle">
		<div class="imgnav">
			<?php if (hasPrevImage()) { ?>
			<div class="imgprevious"><a href="<?php echo htmlspecialchars(getPrevImageURL());?>" title="<?php echo gettext("Fyrri mynd"); ?>">&laquo; <?php echo gettext("fyrri"); ?></a></div>
			<?php } if (hasNextImage()) { ?>
			<div class="imgnext"><a href="<?php echo htmlspecialchars(getNextImageURL());?>" title="<?php echo gettext("N&aelig;sta mynd"); ?>"><?php echo gettext("n&aelig;sta"); ?> &raquo;</a></div>
			<?php } ?>
		</div>
		<h2><a href="http://bthj.is">bthj</a> | <span><?php printHomeLink('', ' | '); ?><a href="<?php echo htmlspecialchars(getGalleryIndexURL());?>" title="<?php gettext('Albums Index'); ?>"><?php echo getGalleryTitle();?>
	...
	<div id="image">
		<?php 
		$isOpenVideo = function_exists('isOpenVideo') && isOpenVideo();
		if( !$isOpenVideo ) {
		?>
